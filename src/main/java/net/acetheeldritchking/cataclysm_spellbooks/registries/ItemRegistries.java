...
public class ItemRegistries {
    public static final DeferredRegister<Item> ITEMS =
        DeferredRegister.create(ForgeRegistries.ITEMS, Cataclysm_Spellbooks.MODID);
    ...
    public static final RegistryObject<Item> CORAL_STAFF = ITEMS.register
            ("coral_staff", () -> new StaffItem
                    (ItemPropertiesHelper.equipment().stacksTo(1).rarity(Rarity.EPIC), 3, -3,
                            Map.of(
                                    CSAttributeRegistry.ABYSSAL_MAGIC_POWER.get(), new AttributeModifier(UUID.fromString("4fce3960-5de6-43c0-bcb1-ec7764d0266a"), "Weapon modifier", .25, AttributeModifier.Operation.MULTIPLY_BASE),
                                    AttributeRegistry.COOLDOWN_REDUCTION.get(), new AttributeModifier(UUID.fromString("704c466a-432d-4274-a10e-7fd65e9ca3ff"), "Weapon modifier", .25, AttributeModifier.Operation.MULTIPLY_BASE)
                            )));
    ...
    public static final RegistryObject<Item> FAKE_WUDJETS_STAFF = ITEMS.register
            ("fake_wudjets_staff", () -> new StaffItem
                    (ItemPropertiesHelper.equipment().stacksTo(1).rarity(Rarity.EPIC), 3, -3,
                            Map.of(
                                    AttributeRegistry.NATURE_SPELL_POWER.get(), new AttributeModifier(UUID.fromString("021f082d-8e7d-4ede-9d5c-37d8c525152a"), "FAKE modifier", .25, AttributeModifier.Operation.MULTIPLY_BASE),
                                    AttributeRegistry.HOLY_SPELL_POWER.get(), new AttributeModifier(UUID.fromString("96af26ef-b543-43ed-a474-bc536e71c9e2"), "FAKE modifier", .25, AttributeModifier.Operation.MULTIPLY_BASE),
                                    AttributeRegistry.COOLDOWN_REDUCTION.get(), new AttributeModifier(UUID.fromString("72a37726-dbfa-4eb5-8287-082e2fbd9560"), "FAKE COOLDOWN", .25, AttributeModifier.Operation.MULTIPLY_BASE)
                            )));
    ...
    public static final RegistryObject<Item> VOID_STAFF = ITEMS.register
            ("void_staff", () -> new StaffItem
                    (ItemPropertiesHelper.equipment().stacksTo(1).rarity(Rarity.EPIC), 3, -3,
                            Map.of(
                                    AttributeRegistry.ENDER_SPELL_POWER.get(), new AttributeModifier(UUID.fromString("2f61779e-7be0-430d-983b-35ed1845c676"), "VOID ENDER", .25, AttributeModifier.Operation.MULTIPLY_BASE),
                                    AttributeRegistry.COOLDOWN_REDUCTION.get(), new AttributeModifier(UUID.fromString("90c07a40-302a-43be-a96f-11050c0c0bbc"), "VOID COOLDOWN", .25, AttributeModifier.Operation.MULTIPLY_BASE)
                            )));
