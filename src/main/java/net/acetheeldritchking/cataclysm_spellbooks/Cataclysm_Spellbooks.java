...
@Mod(Cataclysm_Spellbooks.MODID)
public class Cataclysm_Spellbooks
{
    public static final String MODID = "cataclysm_spellbooks";
    private static final Logger LOGGER = LogUtils.getLogger();

    public Cataclysm_Spellbooks()
    {
    ...
    public static ResourceLocation id(@NotNull String path) {
        return new ResourceLocation(Cataclysm_Spellbooks.MODID, path);
    }
}
