...
public class ConjureAbyssalGnawerSpell extends AbstractAbyssalSpell {
    private final ResourceLocation spellId = new ResourceLocation(Cataclysm_Spellbooks.MODID, "conjure_abyssal_gnawer");
    private final DefaultConfig defaultConfig;


    //THIS SPELL IS WIP AND DISABLED IN SURVIVAL
    //我不知道为什么无法获得 但是好像还没做完
    @Override
    ...
    {
        this.defaultConfig=new DefaultConfig().setMinRarity(SpellRarity.UNCOMMON).setSchoolResource(CSSchoolRegistry.ABYSSAL_RESOURCE).setMaxLevel(6).setCooldownSeconds(80).build();
