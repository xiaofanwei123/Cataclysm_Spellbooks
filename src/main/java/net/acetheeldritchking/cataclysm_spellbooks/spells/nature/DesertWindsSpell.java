...
//TODO:需要修改我觉得应该加上合成限制
@AutoSpellConfig
public class DesertWindsSpell extends AbstractSpell {
    private final ResourceLocation spellId = new ResourceLocation(Cataclysm_Spellbooks.MODID, "desert_winds");
    ...
    public DesertWindsSpell() {
        this.defaultConfig = (new DefaultConfig()).setMinRarity(SpellRarity.RARE).setSchoolResource(SchoolRegistry.NATURE_RESOURCE).setMaxLevel(10).setCooldownSeconds(8.0).build();
