...
public class InfernalBladeRenderer extends GeoEntityRenderer<InfernalBladeProjectile> {
    ...
    public ResourceLocation getTextureLocation(InfernalBladeProjectile animatable) {
        return new ResourceLocation("cataclysm_spellbooks", "textures/entity/infernal_blade_small/infernal_blade_small.png");
    }

    @Override
    public void preRender(PoseStack poseStack, InfernalBladeProjectile animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
