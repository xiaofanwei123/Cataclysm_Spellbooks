...
public class SummonedKoboldiator extends Kobolediator_Entity implements MagicSummon {
    ...
    public void registerGoals() {
        ...
        this.goalSelector.addGoal(9, new LookAtPlayerGoal(this, Mob.class, 9.0F));
        this.targetSelector.addGoal(1, new GenericOwnerHurtByTargetGoal(this, this::getSummoner));
        this.targetSelector.addGoal(2, new GenericOwnerHurtTargetGoal(this, this::getSummoner));
        this.targetSelector.addGoal(3, new GenericCopyOwnerTargetGoal(this, this::getSummoner));
        this.targetSelector.addGoal(4, (new GenericHurtByTargetGoal(this, this::isValidTarget)).setAlertOthers());
        this.goalSelector.addGoal(7, new GenericFollowOwnerGoal(this, this::getSummoner, 1.0f, 10.0F, 2.0F, false, 50.0F));
        super.registerGoals();
    }
    ...
    public boolean doHurtTarget(Entity pEntity) {
        return Utils.doMeleeAttack(this, pEntity, ((AbstractSpell)SpellRegistries.CONJURE_KOBOLDIATOR.get()).getDamageSource(this, this.getSummoner()));
    }
