...
public class SummonedAptrgangr extends Aptrgangr_Entity implements MagicSummon {
    ...
    public void onRemovedFromWorld() {
        this.onRemovedHelper(this, CSPotionEffectRegistry.APTRGANGR_TIMER.get());
        super.onRemovedFromWorld();
    }

    @Override
    public boolean doHurtTarget(Entity pEntity) {
        return Utils.doMeleeAttack(this, pEntity, SpellRegistries.CONJURE_APTRGANGR.get().getDamageSource(this, this.getSummoner()));
    }
